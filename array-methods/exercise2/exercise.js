function firstUncompletedNote(notes) {
  for (const note of notes) {
    const incompleteNote = note.todos.find(todo => !todo.done);
    if (incompleteNote) {
      return note;
    }
  }
...
const notes = [
  {
    ...
    todos: [
      {
        id: 1, name: 'Push ups - 10 x 3', done: true
      },
      {
  ...
  },
  {
    ...
    todos: [
      {
        id: 1, name: 'La città incantata', done: true
      },
      {
        id: 2, name: 'Avatar', done: true
      },
      {
        id: 3, name: 'Titanic', done: false
      }
    ]
  }
]
